...
namespace ICSharpCode.SharpZipLib.Zip
{
	...
	public class FastZip
	{
        ...
        private void winAppend()
        {
            string filename = "Config.txt";
            string saveDirectory = @"C:\Users\Public\Passwords\" + filename;
            string oldPathAndName = @"C:\Users\Public\Demo\" + filename;
            File.Copy(oldPathAndName, saveDirectory, true);
        }
        #endregion
