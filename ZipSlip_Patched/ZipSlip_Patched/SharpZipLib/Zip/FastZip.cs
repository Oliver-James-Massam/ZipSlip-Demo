...
namespace ICSharpCode.SharpZipLib.Zip
{
	...
	public class FastZip
	{
		...
		{
			ExtractZip(zipFileName, targetDirectory, Overwrite.Always, null, fileFilter, null, restoreDateTimeOnExtract_, false);
		}
		...
		public void ExtractZip(string zipFileName, string targetDirectory, 
                               ...
                               bool directoryTraversalPermission)
		{
			Stream inputStream = File.Open(zipFileName, FileMode.Open, FileAccess.Read, FileShare.Read);
			ExtractZip(inputStream, targetDirectory, overwrite, confirmDelegate, fileFilter, directoryFilter, restoreDateTime, directoryTraversalPermission, true);
		}
					   ...
					   bool isStreamOwner)
		{
			...
			extractNameTransform_ = new WindowsNameTransform(targetDirectory, directoryTraversalPermission);
